...
def export_minarai_to_executorch(model_name: str, output_dir: str):
    ...
    metadata = {
        ...
        "export_script_version": "1.1",
        "supports_training": True,
        "training_framework": "ExecuTorch SGD",
        "training_backend": "on-device (Android compatible)",
        "notes": "This model was exported with training support enabled. Use ExecuTorchTrainer for on-device training."
    }
